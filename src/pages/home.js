        ...
        <div class="header">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <h1> About us :  </h1>
                        Bazar is the first online concept store in Tunisia, our platform allows you to connect customers and sellers in order to achieve very good business. <br/>
                        Are you looking to exhibit your products? you can simply subscribe to our platform, post your products frequently so your clientele begins to grow <br/>
                        Are you looking for accessories, decorative items or even personalized gifts? you will always benefit from the lowest prices, among our thousands of products online. <br/>
                        Bazar makes buying and selling online easily and conveniently with short delivery times.                    </div>
                ...
                <div class="row align-items-center product-slider product-slider-4">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="assets/img/chou.jpg" alt="Product Image"/>
                                </a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="assets/img/bougie.jpg" alt="Product Image"/>
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="assets/img/porte.jpg" alt="Product Image"/>
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="assets/img/cheu.jpg" alt="Product Image"/>
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="assets/img/choco.jpg" alt="Product Image"/>
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            ...
                            <div class="review-text">
                                ...
                                <p>
                                    The quality of the service and the products are awesome !
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            ...
                            <div class="review-text">
                                ...
                                <p>
                                    I have received my order very quickly ans I'm really satisfied with the quality of the products.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            ...
                            <div class="review-text">
                                ...
                                <p>
                                    I found what I was looking for in your site. There is a large selection of low priced items.
                                </p>
                            </div>
                        </div>
                    </div>
